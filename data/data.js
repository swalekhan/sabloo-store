...
export const navLink = [
    { id: 1, name: "Home", url: "/" },
    { id: 1, name: "Tiles and Flooring", url: "Tiles" },
    { id: 2, name: "Paints and Surface Care", url: "Paints" },
    { id: 3, name: "Electricals and Lighting", url: "Electrical" },
    { id: 4, name: "Wooden Material", url: "WoodenMaterial" },
    { id: 5, name: "Structural Material", url: "StructuralMaterial" },
    { id: 6, name: "Sanitaryware and Bath Fittings", url: "Bath&Fitting" },
    { id: 7, name: "About", url: "about" },
    { id: 8, name: "Contact Us", url: "ContactUs" },
];

export const myAccount = [
    { id: 1, name: "My Profile", url: "/" },
    { id: 2, name: "My Orders", url: "Tiles" },
    { id: 3, name: "Whislist", url: "WoodenMaterial" },
    { id: 4, name: "Refer now", url: "Paints" },
    { id: 5, name: "My Referrals", url: "Electrical" },
];
